        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              autoFocus
            />
            <p className="text-[11px] text-muted-foreground text-center">{t("totp.codeOrBackup")}</p>
          </div>
          <Button type="submit" className="w-full h-10 font-semibold" disabled={loading || code.length !== 6}>
